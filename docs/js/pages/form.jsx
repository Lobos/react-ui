    ...
    return (
      <div className="content">
        ...
        <Arguments>
          ...
          <Arguments.Item name="layout" type="String" def="null">可选值为<code>null</code>，<code>horizontal</code>，<code>inline</code>。对应bootstrap的<code>form-horizontal</code>，<code>form-inline</code></Arguments.Item>
