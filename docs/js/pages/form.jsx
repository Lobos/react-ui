      ...
      <div className="content">
        ...
        <Example>
          <Form action="none" layout="horizontal">
            <Form.Control name="text" width={5} minlen={2} maxlen={10} required={true} label="text" />
            <Form.Control name="readonly" label="readonly" readOnly={true} />
            <Form.Control name="checkboxgroup" type="checkbox-group" label="checkbox group" src={getSrc('select')} />
            ...
            <Form.Control name="select" width={4} type="select" label="select" src={getSrc('select')} />
